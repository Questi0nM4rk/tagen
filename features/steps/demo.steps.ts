...
Given<TaGenWorld>(
  ...
  async (world: TaGenWorld) => {
    ...
    await writeFile(
      join(skillsDir, "strict-review.md"),
      `---
skill: strict-review
...
`,
    ...
    await writeFile(
      join(skillsDir, "csharp-patterns.md"),
      `---
...
Given<TaGenWorld>(
  ...
  async (world: TaGenWorld) => {
    ...
    // strict-review needs language-patterns; two cards provide it.
    await writeFile(
      join(skillsDir, "strict-review.md"),
      `---
skill: strict-review
...
Then<TaGenWorld>(
  ...
  (world: TaGenWorld) => {
    ...
    expect(combined).toContain("ts-patterns");
  }
);
